...
def summarize(client: OpenAI, llm_model: str, content: str, endpoint: str, dir_name: str) -> str:
...
if __name__ == "__main__":
    ...
    for file_name in sorted(os.listdir(files_path)):
        ...
        with open(file_path, "r", encoding="utf-8") as f:
            content = f.read()
            summarize(client, llm_model, content, os.path.splitext(
                file_name)[0], os.path.join(dir_name, llm_model))
